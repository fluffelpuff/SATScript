...
var (
	...
	PS_ITEM_STATIC_STRING_VALUE  ParsedScriptItemType = ParsedScriptItemType("string_value")
	PS_ITEM_STATIC_VALUE         ParsedScriptItemType = ParsedScriptItemType("static_value")
	...
	PS_ITEM_STATIC_BOOL_VALUE    ParsedScriptItemType = ParsedScriptItemType("bool_value")
)
